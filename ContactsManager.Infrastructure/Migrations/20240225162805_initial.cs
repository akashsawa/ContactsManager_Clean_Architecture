        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxIdentificationNumbers = table.Column<string>(type: "varchar(8)", nullable: true, defaultValue: "ABC12345"),
                    //CountryID = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Persons", x => x.Personid);
                    table.CheckConstraint("CHK_TIN", "len([TaxIdentificationNumbers]) = 8");
                    table.ForeignKey(
